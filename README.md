...
AWS_PROFILE=cool-images-ec2amicreate-egress-assess-packer packer build --timestamp-ui -var release_tag=$(./bump-version show) -var is_prerelease=true .
```
...
```console
AWS_PROFILE=cool-images-ec2amicreate-egress-assess-packer packer build --timestamp-ui -var-file release.pkrvars.hcl .
```

...
[Egress-Assess](https://github.com/FortyNorthSecurity/Egress-Assess) installed.
...
secrets on the
[appropriate page](https://github.com/cisagov/egress-assess-packer/settings/secrets)
...
```console
[build-egress-assess-packer]
aws_access_key_id = AKIAXXXXXXXXXXXXXXXX
aws_secret_access_key = XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX

[cool-images-ec2amicreate-egress-assess-packer]
role_arn = arn:aws:iam::111111111111:role/EC2AMICreate-build-egress-assess-packer
source_profile = build-egress-assess-packer
...
AWS_PROFILE=cool-images-ec2amicreate-egress-assess-packer packer build --timestamp-ui -var release_tag=$(./bump_version.sh show) -var is_prerelease=true src/packer.pkr.hcl
```
...
```console
AWS_PROFILE=cool-images-ec2amicreate-egress-assess-packer packer build --timestamp-ui -var-file release.pkrvars.hcl src/packer.pkr.hcl
```

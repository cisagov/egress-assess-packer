...
issue](https://github.com/cisagov/egress-assess-packer/issues) in this
...
request](https://github.com/cisagov/egress-assess-packer/pulls), you will
...
```console
cd egress-assess-packer
pyenv virtualenv <python_version_to_use> egress-assess-packer
pyenv local egress-assess-packer
